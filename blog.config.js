...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'SleepingYeoug (Not Yeong)', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '只是一个普通的学生', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://sleepingyeoug.com', // 网站地址
